...
import { loadFile, loadLayers, traitsShiftOffset } from './components/banny';

describe('Banny Reward Tests', () => {
    let storage: any;
    let delegate: any;
    ...
    before(async () => {
        ...
        const jbDirectoryABI = JSON.parse(fs.readFileSync('node_modules/@jbx-protocol/juice-contracts-v3/deployments/mainnet/JBDirectory.json').toString())['abi'];
